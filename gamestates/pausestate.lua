...
function PauseState:draw()
   ...
   self.display:putLine(midwidth - 20, midpoint - 7, midwidth - 20, midpoint + 7, "boxv", WHITE, nil, nil)
   self.display:putLine(midwidth - 5, midpoint - 7, midwidth - 5, midpoint + 7, "boxv", WHITE, nil, nil)
   self.display:putLine(midwidth - 1, midpoint - 7, midwidth - 1, midpoint + 7, "boxv", WHITE, nil, nil)
   self.display:putLine(midwidth + 9, midpoint - 7, midwidth + 9, midpoint + 7, "boxv", WHITE, nil, nil)
   self.display:putLine(midwidth + 13, midpoint - 7, midwidth + 13, midpoint + 7, "boxv", WHITE, nil, nil)
   self.display:putLine(midwidth + 19, midpoint - 7, midwidth + 19, midpoint + 7, "boxv", WHITE, nil, nil)
   self.display:putLine(midwidth - 19, midpoint - 8, midwidth + 18, midpoint - 8, "boxh", WHITE, nil, nil)
   self.display:putLine(midwidth - 19, midpoint + 8, midwidth + 18, midpoint + 8, "boxh", WHITE, nil, nil)
   self.display:put(boxRect.x, boxRect.y, "boxdr", WHITE, nil, nil)
   self.display:put(boxRect.x + boxRect.w - 1, boxRect.y, "boxdl", WHITE, nil, nil)
   self.display:put(boxRect.x, boxRect.y + boxRect.h - 1, "boxur", WHITE, nil, nil)
   self.display:put(boxRect.x + boxRect.w - 1, boxRect.y + boxRect.h - 1, "boxul", WHITE, nil, nil)
   self.display:put(boxRect.x + 15, boxRect.y, "boxhd", WHITE, nil, nil)
   self.display:put(boxRect.x + 19, boxRect.y, "boxhd", WHITE, nil, nil)
   self.display:put(boxRect.x + 29, boxRect.y, "boxhd", WHITE, nil, nil)
   self.display:put(boxRect.x + 33, boxRect.y, "boxhd", WHITE, nil, nil)
   self.display:put(boxRect.x + 15, boxRect.y + boxRect.h - 1, "boxhu", WHITE, nil, nil)
   self.display:put(boxRect.x + 19, boxRect.y + boxRect.h - 1, "boxhu", WHITE, nil, nil)
   self.display:put(boxRect.x + 29, boxRect.y + boxRect.h - 1, "boxhu", WHITE, nil, nil)
   self.display:put(boxRect.x + 33, boxRect.y + boxRect.h - 1, "boxhu", WHITE, nil, nil)
